...
export default function DashboardHero({ data, userName }) {
  ...
  return (
    <GlassCard tier={3} className="relative overflow-hidden p-7 sm:p-10 mb-6">
      ...
      {/* Ambient blur blob — was bg-aurora-violet (static purple palette,
          untouched by the accent system). Now reads --accent-* directly. */}
      <div
        className="pointer-events-none absolute -top-24 -right-24 h-72 w-72 rounded-full blur-3xl animate-floaty"
        style={{ background: 'rgb(var(--accent-500) / 0.15)' }}
      />
