...
// (gem / dots / squiggle), since "Mystic Tree" should still look like
// a tree. Same 5 keys as before, so existing saved trees automatically
// pick up the new look with no migration needed.
